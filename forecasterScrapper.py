...
class Forecaster():
    ...
    def scrapeFarmersForecast(self):
        currentLootAvailabilityRegex = re.compile(
            r'(Loot available is )(\w+)( right now\.  This will continue for the next )([\w ]+)')
        ...
        mo = currentLootAvailabilityRegex.search(self.script)
